...
# simple squares or straight lines that cut through them at 2 angles: 
...
for stim in range(data_size):
    ...
    # If it's a line...
        ...
        # Randomly decide whether the line will be vertical or horizontal
        vertical = random.randint(0, 1)
        
        # Assign values depending on the line orientation
        if vertical:
            ln_col_start = random.randint(1, 26)
            ...
            ln_row_start = random.randint(1, 26)
